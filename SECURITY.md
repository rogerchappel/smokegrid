...
Replace this section with the supported versions for `smokegrid`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `smokegrid` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in smokegrid.
